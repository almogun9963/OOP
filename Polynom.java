...
public class Polynom implements Polynom_able{
	...
	/**
	 * this function initialize a Polynom from a string.
	 * @param s represents the string that we want to initialize the Polynom from.
	 * @return the new Polynom that we wanted to initialize from the string.
	 */
	@Override
